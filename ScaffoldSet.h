...
MapRegionGapIndex * GetGapReadFromReadPositionOfContig(ScaffoldSetHead * scaffoldSetHead, long int readLength, long int contigIndex, long int readPosition, long int maxInsetSize, long int minInsertSize, bool isPairedRead, bool isReverse);
